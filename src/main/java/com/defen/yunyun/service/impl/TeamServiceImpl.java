...
import com.defen.yunyun.model.enums.TeamStatusEnum;
...
public class TeamServiceImpl extends ServiceImpl<TeamMapper, Team>
    ...
    public long addTeam(Team team, User loginUser) {
        ...
        // 3. 校验信息
        //   1. 队伍人数 > 1 且 <= 20
        int maxNum = Optional.ofNullable(team.getMemberLimit()).orElse(0);
        ...
        int status = Optional.ofNullable(team.getType()).orElse(0);
    ...
    public boolean updateTeam(TeamUpdateRequest teamUpdateRequest, User loginUser) {
        ...
        // 只有管理员或者队伍的创建者可以修改
        if (oldTeam.getUserId() != loginUser.getId() && loginUser.getUserRole() != UserConstant.ADMIN_ROLE) {
            throw new BusinessException(ErrorCode.NOT_LOGIN_ERROR);
        }
